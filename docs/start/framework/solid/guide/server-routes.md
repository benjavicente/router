...
Once you've processed the request, you can return a `Response` object or `Promise<Response>` or even use any of the helpers from `@benjavicente/solid-start` to manipulate the response.
