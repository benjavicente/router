...
import { createRoute, Link } from '@benjavicente/angular-router-experimental';
import { Route as RootRoute } from './root.route';
import { Outlet, injectNavigate, injectRouterState } from '@benjavicente/angular-router-experimental';
